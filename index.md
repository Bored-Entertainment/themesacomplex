...
<button style="background-color:black; border-color=#ffffff" class="list" href="games">Games</button>
<button style="background-color:black; border-color=#ffffff" class="list" href="emulators">Emulators</button>
<button style="background-color:black; border-color=#ffffff" class="list" href="bypass">Bypasses and Proxys</button>
<br>
<footer>
