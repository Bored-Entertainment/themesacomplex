...
export class Position {
    ...
    move( dir ) {
        ...
        switch ( dir ) {
            ...
            case Direction.NORTH: if ( this.y > 0 ) {
 ...
 break;
            case Direction.NORTHEAST: if ( this.y > 0 && this.x < this.width - 1 ) {

 this.y --; this.x ++; up = true;

}

 break;
            case Direction.EAST: if ( this.x < this.width - 1 ) {
 ...
 break;
            case Direction.SOUTHEAST: if ( this.y < this.height - 1 && this.x < this.width - 1 ) {

 this.x ++; this.y ++; up = true;

}

 break;
            case Direction.SOUTH: if ( this.y < this.height - 1 ) {
 ...
 break;
            case Direction.SOUTHWEST: if ( this.y < this.height - 1 && this.x > 0 ) {
 ...
 break;
            case Direction.WEST: if ( this.x > 0 ) {
 ...
 break;
            case Direction.NORTHWEST: if ( this.y > 0 && this.x > 0 ) {
