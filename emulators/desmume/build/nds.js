...
if (ENVIRONMENT_IS_NODE) { if (ENVIRONMENT_IS_WORKER) { scriptDirectory = require("path").dirname(scriptDirectory) + "/" } else { scriptDirectory = __dirname + "/" }
    ...
    quit_ = function(status, toThrow) { if (keepRuntimeAlive()) { process["exitCode"] = status; throw toThrow }
        process["exit"](status) };
    Module["inspect"] = function() { return "[Emscripten Module object]" } } else if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) { if (ENVIRONMENT_IS_WORKER) { scriptDirectory = self.location.href } else if (typeof document !== "undefined" && document.currentScript) { scriptDirectory = document.currentScript.src } if (scriptDirectory.indexOf("blob:") !== 0) { scriptDirectory = scriptDirectory.substr(0, scriptDirectory.lastIndexOf("/") + 1) } else { scriptDirectory = "" } { read_ = function(url) { var xhr = new XMLHttpRequest;
...
var tempDouble;
var tempI64;
var ASM_CONSTS = { 436609: function() { wasmReady() } };
...
function handleException(e) { if (e instanceof ExitStatus || e == "unwind") { return EXITSTATUS } var toLog = e;
...
function ExceptionInfo(excPtr) { this.excPtr = excPtr;
    ...
    this.release_ref = function() { var prev = HEAP32[this.ptr >> 2];
        HEAP32[this.ptr >> 2] = prev - 1; return prev === 1 } }
...
function _tzset_impl() { var currentYear = (new Date).getFullYear(); var winter = new Date(currentYear, 0, 1); var summer = new Date(currentYear, 6, 1); var winterOffset = winter.getTimezoneOffset(); var summerOffset = summer.getTimezoneOffset(); var stdTimezoneOffset = Math.max(winterOffset, summerOffset);
...
var asmLibraryArg = { "a": ___assert_fail, "c": ___cxa_allocate_exception, "b": ___cxa_throw, "u": ___localtime_r, "g": ___sys_fcntl64, "t": ___sys_ftruncate64, "r": ___sys_ioctl, "s": ___sys_open, "e": _abort, "m": _emscripten_asm_const_int, "l": _emscripten_memcpy_big, "d": _emscripten_resize_heap, "q": _environ_get, "p": _environ_sizes_get, "f": _fd_close, "o": _fd_read, "k": _fd_seek, "n": _fd_write, "j": _setTempRet0, "i": _strftime_l, "h": _time };
var asm = createWasm();
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function() { return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["w"]).apply(null, arguments) };
var _malloc = Module["_malloc"] = function() { return (_malloc = Module["_malloc"] = Module["asm"]["x"]).apply(null, arguments) };
var _realloc = Module["_realloc"] = function() { return (_realloc = Module["_realloc"] = Module["asm"]["y"]).apply(null, arguments) };
var _setSampleRate = Module["_setSampleRate"] = function() { return (_setSampleRate = Module["_setSampleRate"] = Module["asm"]["z"]).apply(null, arguments) };
var _main = Module["_main"] = function() { return (_main = Module["_main"] = Module["asm"]["A"]).apply(null, arguments) };
var _prepareRomBuffer = Module["_prepareRomBuffer"] = function() { return (_prepareRomBuffer = Module["_prepareRomBuffer"] = Module["asm"]["B"]).apply(null, arguments) };
var _getSymbol = Module["_getSymbol"] = function() { return (_getSymbol = Module["_getSymbol"] = Module["asm"]["C"]).apply(null, arguments) };
var _loadROM = Module["_loadROM"] = function() { return (_loadROM = Module["_loadROM"] = Module["asm"]["D"]).apply(null, arguments) };
var _savGetSize = Module["_savGetSize"] = function() { return (_savGetSize = Module["_savGetSize"] = Module["asm"]["E"]).apply(null, arguments) };
var _savGetPointer = Module["_savGetPointer"] = function() { return (_savGetPointer = Module["_savGetPointer"] = Module["asm"]["F"]).apply(null, arguments) };
var _savUpdateChangeFlag = Module["_savUpdateChangeFlag"] = function() { return (_savUpdateChangeFlag = Module["_savUpdateChangeFlag"] = Module["asm"]["G"]).apply(null, arguments) };
var _runFrame = Module["_runFrame"] = function() { return (_runFrame = Module["_runFrame"] = Module["asm"]["H"]).apply(null, arguments) };
var _fillAudioBuffer = Module["_fillAudioBuffer"] = function() { return (_fillAudioBuffer = Module["_fillAudioBuffer"] = Module["asm"]["I"]).apply(null, arguments) };
var _zlibCompress = Module["_zlibCompress"] = function() { return (_zlibCompress = Module["_zlibCompress"] = Module["asm"]["J"]).apply(null, arguments) };
var _zlibDecompress = Module["_zlibDecompress"] = function() { return (_zlibDecompress = Module["_zlibDecompress"] = Module["asm"]["K"]).apply(null, arguments) };
...
var _htons = Module["_htons"] = function() { return (_htons = Module["_htons"] = Module["asm"]["M"]).apply(null, arguments) };
var __get_tzname = Module["__get_tzname"] = function() { return (__get_tzname = Module["__get_tzname"] = Module["asm"]["N"]).apply(null, arguments) };
var __get_daylight = Module["__get_daylight"] = function() { return (__get_daylight = Module["__get_daylight"] = Module["asm"]["O"]).apply(null, arguments) };
var __get_timezone = Module["__get_timezone"] = function() { return (__get_timezone = Module["__get_timezone"] = Module["asm"]["P"]).apply(null, arguments) };
...
var dynCall_viijii = Module["dynCall_viijii"] = function() { return (dynCall_viijii = Module["dynCall_viijii"] = Module["asm"]["V"]).apply(null, arguments) };
var dynCall_iiiiij = Module["dynCall_iiiiij"] = function() { return (dynCall_iiiiij = Module["dynCall_iiiiij"] = Module["asm"]["W"]).apply(null, arguments) };
...
var dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = function() { return (dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = Module["asm"]["Y"]).apply(null, arguments) };
var calledRun;
...
function callMain(args) { var entryFunction = Module["_main"]; var argc = 0; var argv = 0; try { var ret = entryFunction(argc, argv);
        exit(ret, true); return ret } catch (e) { return handleException(e) } finally { calledMain = true } }
...
function exit(status, implicit) { EXITSTATUS = status; if (keepRuntimeAlive()) {} else { exitRuntime() }
    procExit(status) }
