...
export class Simulation {
 ...
 this.doInitialEval = false; this.evaluation.cityEvaluation();
 ...
 this.budget.collectTax( this.gameLevel, this.census ); this.evaluation.cityEvaluation();

}


            break;
            case 10: if ( ( this.simCycle % 5 ) === 0 ) {

 MapUtils.neutraliseRateOfGrowthMap( this.blockMaps );

}

 MapUtils.neutraliseTrafficMap( this.blockMaps ); this.sendMessages(); break;
    ...
    sendMessages() {
        ...
        switch ( this.cityTime & 63 ) {
            ...
            case 26: if ( this.census.resPop > 500 && this.census.stadiumPop === 0 ) {

 this.messageManager.sendMessage( Messages.NEED_STADIUM ); this.valves.resCap = true;
 ...
 break;
            case 28: if ( this.census.indPop > 70 && this.census.seaportPop === 0 ) {

 this.messageManager.sendMessage( Messages.NEED_SEAPORT ); this.valves.indCap = true;
 ...
 break;
            case 30: if ( this.census.comPop > 100 && this.census.airportPop === 0 ) {

 this.messageManager.sendMessage( Messages._NEED_AIRPORT ); this.valves.comCap = true;
 ...
 break;
            case 32: let zoneCount = this.census.unpoweredZoneCount + this.census.poweredZoneCount; if ( zoneCount > 0 ) {
