...
export class Hub {
    ...
    constructor() {
        ...
        this.link = UIL.add( 'button', {
            ...
            button: '#8397ac'
        } ).icon( UIL.Tools.icon( 'github', '#DEDEDE', 50 ) ).onChange( function ( v ) {

 let w = window.open( 'https://github.com/lo-th/3d.city','_blank' );
 ...
 e.preventDefault(); Main.getBudjet();
 ...
 e.preventDefault(); _this.openExit();
 ...
 e.preventDefault(); _this.openAbout();
 ...
 e.preventDefault(); _this.closeAbout();
    ...
    openOverlays( data ) {
        ...
        if ( this.overlaysWindow == null ) {
            ...
            for ( var i = 0; i < this.overlaysTypes.length; i ++ ) {
                ...
                this.overlaysButtons[ i ].addEventListener( 'click', function ( e ) {

 e.preventDefault(); setOverlays( this.name );
 ...
 e.preventDefault(); _this.closeQuery();
 ...
 e.preventDefault(); _this.closeExit();

}, false );
            bg2.addEventListener( 'click', function ( e ) {

 e.preventDefault(); Main.newGameMap();

}, false );
            bg3.addEventListener( 'click', function ( e ) {

 e.preventDefault(); Main.saveGame();

}, false );
            bg4.addEventListener( 'click', function ( e ) {

 e.preventDefault(); Main.loadGame();
 ...
 e.preventDefault(); _this.closeBudget();

}, false );
            bg2.addEventListener( 'click', function ( e ) {

 e.preventDefault(); _this.applyBudget();
    ...
    openDisaster() {
        ...
        if ( this.disasterWindow == null ) {
            ...
            for ( var i = 0; i < this.disasterTypes.length; i ++ ) {
                ...
                this.disasterButtons[ i ].addEventListener( 'click', function ( e ) {

 e.preventDefault(); Main.setDisaster( this.name );
 ...
 e.preventDefault(); this.className = "up"; this.style.backgroundColor = _this.colors[ 1 ];

}, false );
        bg.addEventListener( 'mouseover', function ( e ) {

 e.preventDefault(); this.style.backgroundColor = _this.colors[ 2 ];

}, false );
        bg.addEventListener( 'mouseup', function ( e ) {

 e.preventDefault(); this.className = "up";

}, false );
        bg.addEventListener( 'mousedown', function ( e ) {

 e.preventDefault(); this.className = "down"; _this.dragSlider( this, e.clientX, max );

}, false );
        bg.addEventListener( 'mousemove', function ( e ) {

 e.preventDefault(); _this.dragSlider( this, e.clientX, max );
 ...
 this.R.style.bottom = '42px';

} else {

 this.R.style.bottom = 28 + ( r / 100 ) + 'px';

}

        if ( c > 0 ) {

 this.C.style.bottom = '42px';

} else {

 this.C.style.bottom = 28 + ( c / 100 ) + 'px';

}

        if ( i > 0 ) {

 this.I.style.bottom = '42px';

} else {

 this.I.style.bottom = 28 + ( i / 100 ) + 'px';
 ...
 t[ i ].style.width = size[ i ] + 'px'; t[ i ].style.height = size[ i ] + 'px'; t[ i ].style.padding = '0px';
 ...
 e.preventDefault(); this.style.border = '1px solid ' + _this.colors[ 0 ];

}, false );
            t[ i ].addEventListener( 'mouseout', function ( e ) {

 e.preventDefault(); this.style.border = '1px solid ' + _this.colors[ 5 ];

}, false );

            t[ i ].addEventListener( 'click', function ( e ) {

 e.preventDefault(); fun( this.name ); _this.setActiveSelector( this.name, type );
 ...
 this.full.appendChild( cont ); cont.style.position = 'absolute'; cont.style.top = '200px'; cont.style.width = '300px';
 ...
 e.preventDefault(); _this.selector.style.display = 'none';

}, false );
        b.addEventListener( 'click', function ( e ) {

 e.preventDefault(); _this.showToolSelect( this );
 ...
 e.preventDefault(); this.style.backgroundColor = _this.colors[ 5 ]; this.style.color = _this.colors[ 2 ];

}, false );
        b.addEventListener( 'mouseout', function ( e ) {

 e.preventDefault(); this.style.backgroundColor = _this.colors[ 1 ]; this.style.color = _this.colors[ 0 ];
